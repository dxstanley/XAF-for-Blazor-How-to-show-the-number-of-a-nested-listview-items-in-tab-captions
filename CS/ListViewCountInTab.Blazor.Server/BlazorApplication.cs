...
using ListViewCountInTab.Blazor.Server.Services;

namespace ListViewCountInTab.Blazor.Server {
    public partial class ListViewCountInTabBlazorApplication : BlazorApplication {
        #region Default XAF configuration options (https://www.devexpress.com/kb=T501418)
        static ListViewCountInTabBlazorApplication() {
            DevExpress.Persistent.Base.PasswordCryptographer.EnableRfc2898 = true;
            DevExpress.Persistent.Base.PasswordCryptographer.SupportLegacySha512 = false;
            DevExpress.ExpressApp.BaseObjectSpace.ThrowExceptionForNotRegisteredEntityType = true;
        }
        #endregion
        public ListViewCountInTabBlazorApplication() {
            InitializeComponent();
        }
        ...
        private void ListViewCountInTabBlazorApplication_DatabaseVersionMismatch(object sender, DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
